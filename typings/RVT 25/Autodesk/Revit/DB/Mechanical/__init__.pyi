...
class DuctPressureDropData:
    ...
    @property
    def DynamicViscosity(self) -> float: ...
    @property
...
class DuctSettings(Element):
    ...
    @property
    def AirDynamicViscosity(self) -> float: ...
    @AirDynamicViscosity.setter
    def AirDynamicViscosity(self, airDynamicViscosity: float) -> None: ...
    @property
    ...
    @property
    def NetworkBasedCalculations(self) -> bool: ...
    @NetworkBasedCalculations.setter
    def NetworkBasedCalculations(self, value: bool) -> None: ...
    @property
    def AirViscosity(self) -> float: ...
    @AirViscosity.setter
    def AirViscosity(self, airKinematicViscosity: float) -> None: ...
