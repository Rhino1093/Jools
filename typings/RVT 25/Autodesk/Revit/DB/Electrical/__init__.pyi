...
class DistributionSysType(ElementType):
    ...
    def IsInUse(self) -> bool: ...
    @property
    def HighLegPhase(self) -> ElectricalPhaseLine: ...
    @HighLegPhase.setter
    def HighLegPhase(self, eHighLegPhase: ElectricalPhaseLine) -> None: ...
...
class AnalyticalDistributionNodePropertyData:
    ...
    @property
    def ConnectedPhases(self) -> ElectricalConnectedPhases: ...
    @property
...
class ElectricalPerPhaseData:
    @property
    def CurrentPhaseA(self) -> float: ...
    @property
    def CurrentPhaseB(self) -> float: ...
    @property
    def CurrentPhaseC(self) -> float: ...
    @property
    def IsValidObject(self) -> bool: ...
    def Dispose(self) -> None: ...
...
class AnalyticalPowerDistributableNodeData(AnalyticalDistributionNodePropertyData):
    @property
    def DistributionSystem(self) -> ElementId: ...
    @DistributionSystem.setter
    def DistributionSystem(self, id: ElementId) -> None: ...
    @property
    def AssignedVoltage(self) -> float: ...
    @property
    def AssignedPhasesNumber(self) -> int: ...
    ...
    def GetAllAvailableConnectedPhasesOnDownstream(self, id: ElementId) -> List[ElectricalConnectedPhases]: ...
...
class AnalyticalPowerSourceData(AnalyticalPowerDistributableNodeData):
    ...
    def Voltage(self, voltage: float) -> None: ...
    @property
    def ApparentPowerRating(self) -> float: ...
    @ApparentPowerRating.setter
    def ApparentPowerRating(self, rating: float) -> None: ...
    @property
    def TotalConnectedCurrent(self) -> float: ...
...
class AnalyticalTransformerData(AnalyticalPowerDistributableNodeData):
    @property
    def SecondaryDistributionSystem(self) -> ElementId: ...
    @SecondaryDistributionSystem.setter
    def SecondaryDistributionSystem(self, id: ElementId) -> None: ...
    @property
    def ApparentPowerRating(self) -> float: ...
    @ApparentPowerRating.setter
    def ApparentPowerRating(self, rating: float) -> None: ...
...
class AreaBasedLoadData(ZoneElementDomainData):
    ...
    @PhasesNumber.setter
    def PhasesNumber(self, numberOfPhases: int) -> None: ...
    @property
...
class ElectricalAnalyticalLoadSet(Element):
    @property
    def QuantityOnStandBy(self) -> int: ...
    @QuantityOnStandBy.setter
    def QuantityOnStandBy(self, number: int) -> None: ...
    @property
...
class AreaBasedLoadType(Element):
    @property
    def PowerFactorState(self) -> PowerFactorStateType: ...
    @PowerFactorState.setter
    def PowerFactorState(self, powerFactorState: PowerFactorStateType) -> None: ...
    @property
    def PowerFactor(self) -> float: ...
    @PowerFactor.setter
...
class AnalyticalEquipmentLoadData(AnalyticalDistributionNodePropertyData):
    ...
    def LoadClassification(self, id: ElementId) -> None: ...
    @property
    def LoadSet(self) -> ElementId: ...
    @LoadSet.setter
    def LoadSet(self, loadSetId: ElementId) -> None: ...
    @property
    def ApparentLoad(self) -> float: ...
    @ApparentLoad.setter
