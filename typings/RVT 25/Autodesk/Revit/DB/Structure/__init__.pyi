...
class Rebar(Element):
    ...
    @property
    def CanHaveVaryingLengthBars(self) -> bool: ...
    @property
    def HasVariableLengthBars(self) -> bool: ...
    @overload
...
class LoadBase(Element):
    ...
    @property
    def IsConstrainedOnHost(self) -> bool: ...
    @property
...
class AreaLoad(LoadBase):
    ...
    def Area(self) -> float: ...
    @overload
    def Create(document: Document, hostElemId: ElementId, loops: List[CurveLoop], forceVectors: List[XYZ], refPointCurveIndexes: List[int], refPointCurveEnds: List[int], symbol: AreaLoadType) -> AreaLoad: ...
    @overload
    def Create(document: Document, hostElemId: ElementId, loops: List[CurveLoop], forceVector: XYZ, symbol: AreaLoadType) -> AreaLoad: ...
    @overload
    def Create(document: Document, hostElemId: ElementId, forceVector: XYZ, symbol: AreaLoadType) -> AreaLoad: ...
    def IsValidHostId(pDoc: Document, hostId: ElementId) -> bool: ...
    def AreCurveLoopsValid(loops: List[CurveLoop]) -> bool: ...
    def GetRefPoint(self, index: int) -> XYZ: ...
    def GetLoops(self) -> List[CurveLoop]: ...
    def SetLoops(self, doc: Document, newLoops: List[CurveLoop]) -> bool: ...
    def IsCurveLoopsInsideHostBoundaries(doc: Document, hostId: ElementId, loops: List[CurveLoop]) -> bool: ...
...
class LineLoad(LoadBase):
    ...
    @overload
    def Create(document: Document, hostElemId: ElementId, curveIndex: int, forceVector1: XYZ, momentVector1: XYZ, symbol: LineLoadType) -> LineLoad: ...
    @overload
    def Create(document: Document, hostElemId: ElementId, forceVector1: XYZ, momentVector1: XYZ, symbol: LineLoadType) -> LineLoad: ...
    def IsValidHostId(pDoc: Document, hostId: ElementId) -> bool: ...
...
class PointLoad(LoadBase):
    ...
    @overload
    def Create(document: Document, hostElemId: ElementId, selector: AnalyticalElementSelector, forceVector: XYZ, momentVector: XYZ, symbol: PointLoadType) -> PointLoad: ...
    def IsValidHostId(pDoc: Document, hostId: ElementId) -> bool: ...
...
class BendingDetailCustomFieldProperties:
    @property
    def LineStyleId(self) -> ElementId: ...
    @LineStyleId.setter
    def LineStyleId(self, lineStyleId: ElementId) -> None: ...
    @property
    def ParametersDisplayOption(self) -> BendingDetailDisplayParametersOptions: ...
    @ParametersDisplayOption.setter
    def ParametersDisplayOption(self, parametersDisplayOption: BendingDetailDisplayParametersOptions) -> None: ...
    @property
    def SegmentsRepresentation(self) -> BendingDetailSegmentsRepresentation: ...
    @SegmentsRepresentation.setter
    def SegmentsRepresentation(self, segmentsRepresentation: BendingDetailSegmentsRepresentation) -> None: ...
    @property
    def RepresentaionOf3DShapes(self) -> BendingDetailFor3DShapesOptions: ...
    @RepresentaionOf3DShapes.setter
    def RepresentaionOf3DShapes(self, representaionOf3DShapes: BendingDetailFor3DShapesOptions) -> None: ...
    @property
    def MultipleValuesIndicatorOption(self) -> BendingDetailCustomFieldMultipleValuesIndicatorOptions: ...
    @MultipleValuesIndicatorOption.setter
    def MultipleValuesIndicatorOption(self, multipleValuesIndicatorOption: BendingDetailCustomFieldMultipleValuesIndicatorOptions) -> None: ...
    @property
    def SegmentLengthDimensionTypeId(self) -> ElementId: ...
    @SegmentLengthDimensionTypeId.setter
    def SegmentLengthDimensionTypeId(self, segmentLengthDimensionTypeId: ElementId) -> None: ...
    @property
    def SegmentLengthDimensionsEnabled(self) -> bool: ...
    @SegmentLengthDimensionsEnabled.setter
    def SegmentLengthDimensionsEnabled(self, segmentLengthDimensionsEnabled: bool) -> None: ...
    @property
    def SegmentLengthDimensionsForHooksEnabled(self) -> bool: ...
    @SegmentLengthDimensionsForHooksEnabled.setter
    def SegmentLengthDimensionsForHooksEnabled(self, segmentLengthDimensionsForHooksEnabled: bool) -> None: ...
    @property
    def SegmentLengthDimensionsOffset(self) -> float: ...
    @SegmentLengthDimensionsOffset.setter
    def SegmentLengthDimensionsOffset(self, segmentLengthDimensionsOffset: float) -> None: ...
    @property
    def SegmentLengthDimensionTextPosition(self) -> BendingDetailDimensionTextPosition: ...
    @SegmentLengthDimensionTextPosition.setter
    def SegmentLengthDimensionTextPosition(self, segmentLengthDimensionTextPosition: BendingDetailDimensionTextPosition) -> None: ...
    @property
    def SegmentLengthsDisplayOption(self) -> BendingDetailSegmentLengthsDisplayOptions: ...
    @SegmentLengthsDisplayOption.setter
    def SegmentLengthsDisplayOption(self, segmentLengthsDisplayOption: BendingDetailSegmentLengthsDisplayOptions) -> None: ...
    @property
    def SegmentLengthsForArcsDisplayOption(self) -> BendingDetailSegmentLengthsDisplayOptions: ...
    @SegmentLengthsForArcsDisplayOption.setter
    def SegmentLengthsForArcsDisplayOption(self, segmentLengthsForArcsDisplayOption: BendingDetailSegmentLengthsDisplayOptions) -> None: ...
    @property
    def OrthogonalAndOverallDimesionsEnabled(self) -> bool: ...
    @OrthogonalAndOverallDimesionsEnabled.setter
    def OrthogonalAndOverallDimesionsEnabled(self, orthogonalAndOverallDimesionsEnabled: bool) -> None: ...
    @property
    def AngularDimensionTypeId(self) -> ElementId: ...
    @AngularDimensionTypeId.setter
    def AngularDimensionTypeId(self, angularDimensionTypeId: ElementId) -> None: ...
    @property
    def AngularDimensionsEnabled(self) -> bool: ...
    @AngularDimensionsEnabled.setter
    def AngularDimensionsEnabled(self, angularDimensionsEnabled: bool) -> None: ...
    @property
    def AngularDimensionTextPosition(self) -> BendingDetailDimensionTextPosition: ...
    @AngularDimensionTextPosition.setter
    def AngularDimensionTextPosition(self, angularDimensionTextPosition: BendingDetailDimensionTextPosition) -> None: ...
    @property
    def AngularDimensionsDisplayOption(self) -> BendingDetailAngularDimensionsDisplayOptions: ...
    @AngularDimensionsDisplayOption.setter
    def AngularDimensionsDisplayOption(self, angularDimensionsDisplayOption: BendingDetailAngularDimensionsDisplayOptions) -> None: ...
    @property
    def AngularDimensionsForHooksEnabled(self) -> bool: ...
    @AngularDimensionsForHooksEnabled.setter
    def AngularDimensionsForHooksEnabled(self, angularDimensionsForHooksEnabled: bool) -> None: ...
    @property
    def AngularDimensionsOffset(self) -> float: ...
    @AngularDimensionsOffset.setter
    def AngularDimensionsOffset(self, angularDimensionsOffset: float) -> None: ...
    @property
    def AngularDimensionsMeasurementOptions(self) -> BendingDetailAngularDimensionsMeasurementOptions: ...
    @AngularDimensionsMeasurementOptions.setter
    def AngularDimensionsMeasurementOptions(self, angularDimensionsMeasurementOptions: BendingDetailAngularDimensionsMeasurementOptions) -> None: ...
    @property
    def RadialDimensionTypeId(self) -> ElementId: ...
    @RadialDimensionTypeId.setter
    def RadialDimensionTypeId(self, radialDimensionTypeId: ElementId) -> None: ...
    @property
    def DiameterDimensionTypeId(self) -> ElementId: ...
    @DiameterDimensionTypeId.setter
    def DiameterDimensionTypeId(self, diameterDimensionTypeId: ElementId) -> None: ...
    @property
    def BendDiameterDimensionsEnabled(self) -> bool: ...
    @BendDiameterDimensionsEnabled.setter
    def BendDiameterDimensionsEnabled(self, bendDiameterDimensionsEnabled: bool) -> None: ...
    @property
    def BendDiameterDimensionType(self) -> BendingDetailBendDiameterDimensionType: ...
    @BendDiameterDimensionType.setter
    def BendDiameterDimensionType(self, bendDiameterDimensionType: BendingDetailBendDiameterDimensionType) -> None: ...
    @property
    def BendDiameterDimensionsForHooksEnabled(self) -> bool: ...
    @BendDiameterDimensionsForHooksEnabled.setter
    def BendDiameterDimensionsForHooksEnabled(self, bendDiameterDimensionsForHooksEnabled: bool) -> None: ...
    @property
    def BendDiameterDimensionsForSegmentsEnabled(self) -> bool: ...
    @BendDiameterDimensionsForSegmentsEnabled.setter
    def BendDiameterDimensionsForSegmentsEnabled(self, bendDiameterDimensionsForSegmentsEnabled: bool) -> None: ...
    @property
    def IsValidObject(self) -> bool: ...
...
class RebarSpliceGeometry:
    def __init__(self, spliceOrigin: XYZ, spliceNormal: XYZ): ...
    @property
    def SpliceOrigin(self) -> XYZ: ...
    @SpliceOrigin.setter
    def SpliceOrigin(self, spliceOrigin: XYZ) -> None: ...
    @property
    def SpliceNormal(self) -> XYZ: ...
    @SpliceNormal.setter
    def SpliceNormal(self, spliceNormal: XYZ) -> None: ...
    @property
    def IsValidObject(self) -> bool: ...
    def Dispose(self) -> None: ...
...
class RebarSpliceOptions:
    def __init__(self, document: Document, spliceTypeId: ElementId, splicePosition: RebarSplicePosition): ...
    @property
    def SplicePosition(self) -> RebarSplicePosition: ...
    @SplicePosition.setter
    def SplicePosition(self, splicePosition: RebarSplicePosition) -> None: ...
    @property
    def SpliceTypeId(self) -> ElementId: ...
    @SpliceTypeId.setter
    def SpliceTypeId(self, spliceTypeId: ElementId) -> None: ...
    @property
    def IsValidObject(self) -> bool: ...
    def Dispose(self) -> None: ...
...
class RebarUpdateCurvesData:
    ...
    @property
    def CycleCounterChanged(self) -> bool: ...
    @property
    def AreOrientationOptionsChanged(self) -> bool: ...
    @property
    def AlignedFreeFormSetOrientationOptions(self) -> AlignedFreeFormSetOrientationOptions: ...
    @property
    def IsValidObject(self) -> bool: ...
...
class RebarConstraintsManager:
    ...
    def SetPreferredConstraintsToSurfaceForHandles(self, handles: List[RebarConstrainedHandle]) -> None: ...
...
class RebarFreeFormAccessor:
    ...
    @property
    def CycleCounter(self) -> int: ...
    @CycleCounter.setter
    def CycleCounter(self, cycleCounter: int) -> None: ...
    @property
    def AlignedFreeFormSetOrientationOptions(self) -> AlignedFreeFormSetOrientationOptions: ...
    @AlignedFreeFormSetOrientationOptions.setter
    def AlignedFreeFormSetOrientationOptions(self, alignedOptions: AlignedFreeFormSetOrientationOptions) -> None: ...
    @property
    def IsValidObject(self) -> bool: ...
...
class RebarShapeDrivenAccessor:
    ...
    @property
    def UseRebarConstraintsToProduceVaryingBars(self) -> bool: ...
    @UseRebarConstraintsToProduceVaryingBars.setter
    def UseRebarConstraintsToProduceVaryingBars(self, useRebarConstraintsToProduceVaryingBars: bool) -> None: ...
    @property
    def IsValidObject(self) -> bool: ...
...
class RebarSplice:
    @property
    def ConnectedRebarId(self) -> ElementId: ...
    @property
    def SourceRebarId(self) -> ElementId: ...
    @property
    def SourceRebarEnd(self) -> int: ...
    @property
    def ConnectedRebarEnd(self) -> int: ...
    @property
    def SpliceTypeId(self) -> ElementId: ...
    @SpliceTypeId.setter
    def SpliceTypeId(self, spliceTypeId: ElementId) -> None: ...
...
class RebarBendingDetail:
    ...
    def AddHosts(bendingDetail: Element, references: List[Reference]) -> None: ...
    def RemoveHosts(bendingDetail: Element, references: List[Reference]) -> None: ...
    def GetHosts(bendingDetail: Element) -> List[Reference]: ...
...
class RebarBendingDetailType(ElementType):
    ...
    def RepresentaionOf3DShapes(self, representaionOf3DShapes: BendingDetailFor3DShapesOptions) -> None: ...
    @property
    def SchematicWidth(self) -> float: ...
    @SchematicWidth.setter
    def SchematicWidth(self, schematicWidth: float) -> None: ...
    @property
    def SchematicHeight(self) -> float: ...
    @SchematicHeight.setter
    def SchematicHeight(self, schematicHeight: float) -> None: ...
    @property
    def TagTypeId(self) -> ElementId: ...
    @TagTypeId.setter
    def TagTypeId(self, tagTypeId: ElementId) -> None: ...
    @property
    def MultipleValuesIndicatorOption(self) -> BendingDetailTypeMultipleValuesIndicatorOptions: ...
    @MultipleValuesIndicatorOption.setter
    def MultipleValuesIndicatorOption(self, multipleValuesIndicatorOption: BendingDetailTypeMultipleValuesIndicatorOptions) -> None: ...
    @property
    def DetailLevel(self) -> BendingDetailLevelOfDetail: ...
    @DetailLevel.setter
    def DetailLevel(self, detailLevel: BendingDetailLevelOfDetail) -> None: ...
    @property
    def SegmentLengthDimensionsEnabled(self) -> bool: ...
    @SegmentLengthDimensionsEnabled.setter
    def SegmentLengthDimensionsEnabled(self, segmentLengthDimensionsEnabled: bool) -> None: ...
    ...
    def BendDiameterDimensionsForHooksEnabled(self, bendDiameterDimensionsForHooksEnabled: bool) -> None: ...
    @property
    def DisplayMode(self) -> BendingDetailDisplayMode: ...
    def CreateSchematic(Document: Document) -> RebarBendingDetailType: ...
    def CreateRealistic(Document: Document) -> RebarBendingDetailType: ...
    def Create(Document: Document) -> RebarBendingDetailType: ...


class RebarConstrainedHandle:
    @property
    def HandleBehavior(self) -> RebarHandleBehavior: ...
    @HandleBehavior.setter
    def HandleBehavior(self, handleBehavior: RebarHandleBehavior) -> None: ...
    @property
    def IsValidObject(self) -> bool: ...
    ...
    def Move(self, translataion: XYZ) -> None: ...
    ...
    def GetPossibleHandleBehaviors(self) -> List[RebarHandleBehavior]: ...
    def Dispose(self) -> None: ...
...
class RebarSpliceRules:
    @property
    def MaximumBarLength(self) -> float: ...
    @MaximumBarLength.setter
    def MaximumBarLength(self, maximumBarLength: float) -> None: ...
    @property
    def MinimumBarLength(self) -> float: ...
    @MinimumBarLength.setter
    def MinimumBarLength(self, minimumBarLength: float) -> None: ...
    @property
    def RunOutPosition(self) -> RebarSpliceByRulesRunOutPosition: ...
    @RunOutPosition.setter
    def RunOutPosition(self, runOutPosition: RebarSpliceByRulesRunOutPosition) -> None: ...
    @property
    def IsValidObject(self) -> bool: ...
...
class RebarSpliceTypeUtils:
    ...
    def GetAllRebarSpliceTypes(document: Document) -> List[ElementId]: ...
...
class RebarSpliceByRulesResult:
    @property
    def Error(self) -> RebarSpliceByRulesError: ...
    @property
    def IsValidObject(self) -> bool: ...
    def GetSpliceGeometries(self) -> List[RebarSpliceGeometry]: ...
    def Dispose(self) -> None: ...


class RebarSpliceUtils:
    @overload
    def SpliceRebar(document: Document, rebarIdToSplit: ElementId, spliceOptions: RebarSpliceOptions, line: Line, linePlaneNormal: XYZ) -> List[ElementId]: ...
    @overload
    def SpliceRebar(document: Document, rebarIdToSplit: ElementId, spliceOptions: RebarSpliceOptions, line: Line, viewId: ElementId) -> List[ElementId]: ...
    @overload
    def SpliceRebar(document: Document, rebarIdToSplit: ElementId, spliceOptions: RebarSpliceOptions, spliceGeometries: List[RebarSpliceGeometry]) -> List[ElementId]: ...
    def GetSpliceGeometries(document: Document, rebarIdToSplit: ElementId, spliceOptions: RebarSpliceOptions, spliceRules: RebarSpliceRules) -> RebarSpliceByRulesResult: ...
    @overload
    def CanRebarBeSpliced(rebar: Rebar, spliceOptions: RebarSpliceOptions, line: Line, linePlaneNormal: XYZ) -> RebarSpliceError: ...
    @overload
    def CanRebarBeSpliced(rebar: Rebar, spliceOptions: RebarSpliceOptions, line: Line, viewId: ElementId) -> RebarSpliceError: ...
    @overload
    def CanRebarBeSpliced(rebar: Rebar, spliceOptions: RebarSpliceOptions, spliceGeometry: RebarSpliceGeometry) -> RebarSpliceError: ...
    def GetSpliceChain(rebar: Rebar) -> List[ElementId]: ...
...
class StructuralSettings(Element):
    ...
    @property
    def UseLoadsDisplayScaling(self) -> bool: ...
    @UseLoadsDisplayScaling.setter
    def UseLoadsDisplayScaling(self, useLoadsDisplayScaling: bool) -> None: ...
