...
class BuildingOperatingDaySchedule(Element):
    ...
    @ScheduleName.setter
    def ScheduleName(self, name: str) -> None: ...
...
class CriticalPathIterator:
    ...
    @property
    def Current(self) -> MEPNetworkSegmentId: ...
    def Dispose(self) -> None: ...


class CriticalPathCollector:
    def __init__(self, doc: Document, segmentId: MEPNetworkSegmentId): ...
    @property
    def IsValidObject(self) -> bool: ...
    def ToNetworkSegmentIds(self) -> List[MEPNetworkSegmentId]: ...
...
class MEPNetworkSegmentId:
    @overload
    def __init__(self, idElem: ElementId, segment: int): ...
    @overload
    def __init__(self): ...
    @property
    def ElementId(self) -> ElementId: ...
    @ElementId.setter
    def ElementId(self, elementId: ElementId) -> None: ...
    @property
    def SegmentId(self) -> int: ...
    @SegmentId.setter
    def SegmentId(self, segmentId: int) -> None: ...
    @property
    def IsValidObject(self) -> bool: ...
...
class EnergyAnalysisConstruction(Element):
    ...
    @property
    def ConstructionName(self) -> str: ...
    @property
    def Description(self) -> str: ...
    @property
    def HeatTransferCoefficient(self) -> float: ...
    @property
    def ThermalResistance(self) -> float: ...
    @property
    def ThermalMass(self) -> float: ...
    @property
    def Absorptance(self) -> float: ...
    @property
    def Roughness(self) -> int: ...
    @overload
    def GetMaterialIds(self) -> List[ElementId]: ...
...
class EnergyAnalysisOpening(Element):
    ...
    @property
    def OriginatingElementId(self) -> LinkElementId: ...
    @property
    ...
    @property
    def OriginatingElementName(self) -> str: ...
    @property
...
class EnergyAnalysisWindowType(Element):
    ...
    def IsSchematic(self) -> bool: ...
    @property
    def WindowTypeName(self) -> str: ...
    @property
    def Description(self) -> str: ...
    @property
    def HeatTransferCoefficient(self) -> float: ...
    @property
    def SolarHeatGainCoefficient(self) -> float: ...
    @property
...
class EnergyDataSettings(Element):
    ...
    @property
    def UseCurrentViewOnly(self) -> bool: ...
    @UseCurrentViewOnly.setter
    def UseCurrentViewOnly(self, useCurrentViewOnly: bool) -> None: ...
    @property
...
class MEPAnalyticalNode:
    ...
    def Id(self) -> int: ...
    @property
    def IsFocalNode(self) -> bool: ...
    @property
    def IsFlowBlocked(self) -> bool: ...
    @property
...
class MEPAnalyticalSegment:
    @property
    def DomainType(self) -> ConnectorDomainType: ...
    @property
    def SegmentType(self) -> MEPAnalyticalSegmentType: ...
    @property
    ...
    @property
    def RevitElementId(self) -> ElementId: ...
    @property
    def DemandFlow(self) -> float: ...
    @property
    def Area(self) -> float: ...
    @property
    def IsValidObject(self) -> bool: ...
...
class MEPNetworkSegmentData:
    @overload
    def __init__(self, other: MEPNetworkSegmentData): ...
    @overload
    def __init__(self): ...
    @property
    def IsCriticalPath(self) -> bool: ...
    @property
    ...
    def IsValidObject(self) -> bool: ...
    def IsValid(self) -> bool: ...
    def GetUpstreamSegments(self) -> List[MEPNetworkSegmentId]: ...
    def GetDownstreamSegments(self) -> List[MEPNetworkSegmentId]: ...
    def Dispose(self) -> None: ...


class MEPNetworkIterator:
    @overload
    def __init__(self, pADoc: Document, startSegment: MEPAnalyticalSegment): ...
    @overload
    def __init__(self, pADoc: Document, startNode: MEPAnalyticalNode, startSegment: MEPAnalyticalSegment): ...
    @overload
    def __init__(self, pADoc: Document, seed: MEPAnalyticalModelData, eDomain: ConnectorDomainType): ...
    @property
    def SystemId(self) -> ElementId: ...
    @SystemId.setter
    def SystemId(self, systemId: ElementId) -> None: ...
    @property
    def SystemClassification(self) -> MEPSystemClassification: ...
    @SystemClassification.setter
    def SystemClassification(self, systemClassification: MEPSystemClassification) -> None: ...
    @property
    def CurrentElementId(self) -> ElementId: ...
    @property
    def IsValidObject(self) -> bool: ...
    def Start(self) -> None: ...
    def End(self) -> bool: ...
